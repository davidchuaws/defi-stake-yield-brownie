...
from scripts.helpful_scripts import DECIMALS, INITIAL_PRICE_FEED_VALUE, LOCAL_BLOCKCHAIN_ENVIRONMENTS, get_contract, get_account
...
def test_issue_tokens(amount_staked):
    ...
    # assert
    # staking 1 dapp_token == value of 1 ETH
    # mock contract has initial value of $2000 per ETH
    assert (
